...
public class IoTTouchPress extends TranslatorBlock
{

  public IoTTouchPress (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
