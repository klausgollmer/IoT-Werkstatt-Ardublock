...
public class IoTMessageString extends TranslatorBlock
{

  public IoTMessageString (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
