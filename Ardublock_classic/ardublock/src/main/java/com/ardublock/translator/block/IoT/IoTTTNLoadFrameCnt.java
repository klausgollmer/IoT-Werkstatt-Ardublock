...
public class IoTTTNLoadFrameCnt  extends TranslatorBlock {
	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");
	public IoTTTNLoadFrameCnt (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
...
//      "    ESP.rtcUserMemoryRead(0, (uint32_t*) &RTCData, sizeof(RTCData)); \n"+	
		...
		slot = tb.toCode();	
		String Code = "LMIC.seqnoUp = float2cnt(RTCData.data[RTCvalidateSlot("+slot+")]);\n";
