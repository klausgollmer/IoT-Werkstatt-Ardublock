...
public class IoTNFCWrite extends TranslatorBlock
{
  ...
  public IoTNFCWrite (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
  ...
  public String toCode() throws SocketNullException, SubroutineNotDeclaredException
  {
    ...
    Read= "// -----------  Schreibefunktion NFC-Tag, wartet auf Tag\n"
        ...
        + "      OK = 0;     \n"
        + "      Wire.begin(GPIO_I2C_SDA, GPIO_I2C_SCL);                          // I2C-Bus restart\n" 
        + "      #if defined(ESP8266)\n if (Wire.status() != I2C_OK) Serial.println(F(\"Something wrong with I2C\")); \n #endif \n"
        + "      nfcSeed.begin();\n"
        + "    }\n"
        + "  }\n"
