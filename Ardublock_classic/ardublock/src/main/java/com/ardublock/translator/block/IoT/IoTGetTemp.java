...
public class IoTGetTemp extends TranslatorBlock
{

  public IoTGetTemp (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
