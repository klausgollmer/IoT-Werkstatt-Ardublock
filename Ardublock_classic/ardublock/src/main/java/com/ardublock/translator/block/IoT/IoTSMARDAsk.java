...
public class IoTSMARDAsk  extends TranslatorBlock {

	public IoTSMARDAsk (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
