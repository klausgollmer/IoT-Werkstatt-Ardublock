...
public class HTTP_IFTTTTrigger  extends TranslatorBlock {

	public HTTP_IFTTTTrigger (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
