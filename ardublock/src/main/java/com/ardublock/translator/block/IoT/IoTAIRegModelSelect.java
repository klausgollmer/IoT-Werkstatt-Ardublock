...
public class IoTAIRegModelSelect  extends TranslatorBlock {

	public IoTAIRegModelSelect (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
