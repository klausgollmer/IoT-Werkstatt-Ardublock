...
public class MINT_HoyMget  extends TranslatorBlock {

	public MINT_HoyMget (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
