...
public class Sen_TouchPress extends TranslatorBlock
{

  public Sen_TouchPress (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
