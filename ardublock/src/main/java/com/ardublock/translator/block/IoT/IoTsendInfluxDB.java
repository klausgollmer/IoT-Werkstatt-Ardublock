...
public class IoTsendInfluxDB  extends TranslatorBlock {

	public IoTsendInfluxDB (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
