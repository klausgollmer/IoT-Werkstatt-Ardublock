...
public class LORA_TTNSend_abp  extends TranslatorBlock {

	public LORA_TTNSend_abp (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
