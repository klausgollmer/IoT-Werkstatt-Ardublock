...
public class MINT_DIYSpektro  extends TranslatorBlock {

	public MINT_DIYSpektro (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
