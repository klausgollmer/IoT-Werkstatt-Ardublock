...
public class ExtSen_PSread  extends TranslatorBlock {

	public ExtSen_PSread (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
