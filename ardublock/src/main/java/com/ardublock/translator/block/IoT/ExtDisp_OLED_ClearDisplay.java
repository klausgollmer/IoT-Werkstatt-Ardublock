...
public class ExtDisp_OLED_ClearDisplay  extends TranslatorBlock {

	public ExtDisp_OLED_ClearDisplay (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
