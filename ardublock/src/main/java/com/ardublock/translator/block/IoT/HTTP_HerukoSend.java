...
public class HTTP_HerukoSend  extends TranslatorBlock {

	public HTTP_HerukoSend (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
