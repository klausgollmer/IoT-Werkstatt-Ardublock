...
public class IoTAIClassifySample  extends TranslatorBlock {

	public IoTAIClassifySample (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
