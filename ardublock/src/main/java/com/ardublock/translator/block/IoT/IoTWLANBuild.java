...
public class IoTWLANBuild  extends TranslatorBlock {

	public IoTWLANBuild (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
