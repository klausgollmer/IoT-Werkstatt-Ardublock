...
public class ExtSen_PScal  extends TranslatorBlock {

	public ExtSen_PScal (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
