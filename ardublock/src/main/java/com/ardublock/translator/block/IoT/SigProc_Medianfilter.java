...
public class SigProc_Medianfilter extends TranslatorBlock
{

  public SigProc_Medianfilter (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
