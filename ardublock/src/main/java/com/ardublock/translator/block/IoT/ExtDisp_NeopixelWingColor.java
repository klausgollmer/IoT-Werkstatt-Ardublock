...
public class ExtDisp_NeopixelWingColor  extends TranslatorBlock {

	public ExtDisp_NeopixelWingColor (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	//@Override
		...
		String Cmd = "// -----------------------  NeoPixelWing-Farbansteuerung\n"
				+ "Adafruit_NeoPixel neoWing = Adafruit_NeoPixel(32,IOTW_GPIO_NEOWING,NEO_GRB + NEO_KHZ800);\n"
