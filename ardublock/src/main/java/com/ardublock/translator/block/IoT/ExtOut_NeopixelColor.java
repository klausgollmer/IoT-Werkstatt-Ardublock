...
public class ExtOut_NeopixelColor  extends TranslatorBlock {

	public ExtOut_NeopixelColor (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
