...
public class HTTP_ShellyMeter  extends TranslatorBlock {

	public HTTP_ShellyMeter (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
