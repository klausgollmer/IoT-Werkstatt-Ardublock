...
public class IoTDIYSpektro_BH  extends TranslatorBlock {

	public IoTDIYSpektro_BH (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
