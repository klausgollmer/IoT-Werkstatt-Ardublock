...
public class IoTOLED_Print  extends TranslatorBlock {

	public IoTOLED_Print (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
