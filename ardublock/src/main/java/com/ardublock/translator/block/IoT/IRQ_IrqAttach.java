...
public class IRQ_IrqAttach  extends TranslatorBlock {

	public IRQ_IrqAttach (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
