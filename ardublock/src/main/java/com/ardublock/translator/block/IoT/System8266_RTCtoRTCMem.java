...
public class System8266_RTCtoRTCMem  extends TranslatorBlock {
	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");
	public System8266_RTCtoRTCMem (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
...
//      "    ESP.rtcUserMemoryRead(0, (uint32_t*) &RTCData, sizeof(RTCData)); \n"+	
		...
		String Code = "// ------  Save Array to RTC-RAM\n"+
