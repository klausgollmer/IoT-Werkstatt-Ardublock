...
public class AI_EDGE_RegModelCalculate  extends TranslatorBlock {

	public AI_EDGE_RegModelCalculate (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
...
*/
		...
		String v1,v2,v3,modeltype;
		 String Code="AI_RegModelCalculate("; 
		    ...
		    if (translatorBlock!=null) {
		       modeltype= translatorBlock.toCode();
			   Code+=","+modeltype+")";
		    }
