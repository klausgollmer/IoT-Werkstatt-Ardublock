...
public class IoTWLANConnectTO  extends TranslatorBlock {

	public IoTWLANConnectTO (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
