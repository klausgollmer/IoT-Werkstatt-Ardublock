...
public class MINT_HoyMinit  extends TranslatorBlock {

	public MINT_HoyMinit (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
