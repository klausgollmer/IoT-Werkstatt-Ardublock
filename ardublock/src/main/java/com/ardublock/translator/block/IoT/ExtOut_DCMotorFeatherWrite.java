...
public class ExtOut_DCMotorFeatherWrite extends TranslatorBlock
{

  public ExtOut_DCMotorFeatherWrite (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
