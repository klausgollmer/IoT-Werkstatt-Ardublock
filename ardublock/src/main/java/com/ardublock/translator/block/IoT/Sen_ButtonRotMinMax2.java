...
public class Sen_ButtonRotMinMax2 extends TranslatorBlock
{

  public Sen_ButtonRotMinMax2 (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		 ...
		 String start = translatorBlock.toCode();
