...
public class Var_2DArraySet  extends TranslatorBlock {
	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");
	public Var_2DArraySet (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
...
//		String name="TEST";
		String dum ="#ifndef IOTW_A2D_DEFAULT_SIZE\n"
		 		  + "  #define IOTW_A2D_DEFAULT_SIZE 20\n"
				  + "#endif\n";
		...
		String Code = "  A2D_"+name+"[A2DCheck("+z+",SIZE1_"+name+")] [A2DCheck("+s+",SIZE2_"+name+")] =" + val +";"; 
