...
public class System8266_RTCfromRTCMem  extends TranslatorBlock {
	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");
	public System8266_RTCfromRTCMem (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
...
//      "    ESP.rtcUserMemoryRead(0, (uint32_t*) &RTCData, sizeof(RTCData)); \n"+	
		...
		String Code = "// ------  Load Array from RTC-RAM\n"+
	     "ESP.rtcUserMemoryRead(0, (uint32_t*) &RTCData, sizeof(RTCData));\n ";
