...
public class HTTP_EcoflowGet  extends TranslatorBlock {

	public HTTP_EcoflowGet (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
