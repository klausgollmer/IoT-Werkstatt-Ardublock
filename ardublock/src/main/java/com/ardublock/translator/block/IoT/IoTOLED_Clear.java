...
public class IoTOLED_Clear  extends TranslatorBlock {

	public IoTOLED_Clear (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
