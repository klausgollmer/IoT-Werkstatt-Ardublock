...
public class HTTP_REST_Get  extends TranslatorBlock {

	public HTTP_REST_Get (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
