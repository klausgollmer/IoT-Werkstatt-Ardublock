...
public class IRQ_TimerAttach  extends TranslatorBlock {

	public IRQ_TimerAttach (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
