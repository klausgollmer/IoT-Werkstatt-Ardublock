...
public class ExtDisp_MatrixArrayPrint  extends TranslatorBlock {

	public ExtDisp_MatrixArrayPrint (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
