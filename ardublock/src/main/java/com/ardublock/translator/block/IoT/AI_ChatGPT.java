...
public class AI_ChatGPT  extends TranslatorBlock {

	public AI_ChatGPT (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
        ...
        Get ="String askChatGPT(String model, String content, bool debug) {\r\n"
        		...
        		+ "  if (debug) {\r\n"
        		+ "    IOTW_PRINTLN(\"[ChatGPT] Sending content message...\");\r\n"
        		+ "    IOTW_PRINTLN(content);\r\n"
        		+ "  }\r\n"
        		...
        		+ "  if (success) {\r\n"
        		+ "    if (debug) IOTW_PRINT(\"[ChatGPT] Response: \");\r\n"
        		+ "    if (debug) IOTW_PRINTLN(result);\r\n"
        		+ "  } else {\r\n"
        		+ "    IOTW_PRINT(\"[ChatGPT] Error: \");\r\n"
        		+ "    IOTW_PRINTLN(result);\r\n"
        		+ "  }\r\n"
        		+ "  return result;\r\n"
        		+ "}";
