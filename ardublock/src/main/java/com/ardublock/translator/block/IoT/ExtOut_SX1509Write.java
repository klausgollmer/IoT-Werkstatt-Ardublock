...
public class ExtOut_SX1509Write extends TranslatorBlock
{

  public ExtOut_SX1509Write (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		String ret = "io.digitalWrite("+ pin +","+level+"); // Ausgabe auf Port Expander \n";	
