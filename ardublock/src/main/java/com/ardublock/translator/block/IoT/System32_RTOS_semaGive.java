...
public class System32_RTOS_semaGive  extends TranslatorBlock {
	public System32_RTOS_semaGive (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	String ret = "xSemaphoreGive("+Sema+");";
  	return ret;
 	}
}
