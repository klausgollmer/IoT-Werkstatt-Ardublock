...
public class IoTNOWSendPeer extends TranslatorBlock
{

  public IoTNOWSendPeer (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
