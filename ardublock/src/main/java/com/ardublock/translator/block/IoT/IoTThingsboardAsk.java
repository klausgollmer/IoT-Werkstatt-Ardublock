...
public class IoTThingsboardAsk  extends TranslatorBlock {

	public IoTThingsboardAsk (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
