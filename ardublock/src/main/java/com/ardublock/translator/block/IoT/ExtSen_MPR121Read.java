...
public class ExtSen_MPR121Read extends TranslatorBlock
{

  public ExtSen_MPR121Read (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
	    ...
	    String Setup = "if (!cap1.begin(0x5B)) { IOTW_PRINTLN(\"Failed to communicate MPR121 Touch\");while (1) {delay(1);};}// 0x5A \n";
