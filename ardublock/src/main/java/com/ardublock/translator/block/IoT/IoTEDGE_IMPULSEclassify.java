...
public class IoTEDGE_IMPULSEclassify  extends TranslatorBlock {

	public IoTEDGE_IMPULSEclassify (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	//	translator.addHeaderFile("#if defined(ESP8266)\n #include <ESP8266HTTPClient.h> \n#elif defined(ESP32) \n #include <HTTPClient.h>\n#endif\n");
		...
		String fun = "int raw_feature_get_data(size_t offset, size_t length, float *out_ptr);\n"
				...
				+ "    Serial.print(F(\"FEHLER: Klassifizierer konnte nicht ausgeführt werden\"));\n"
				+ "    Serial.println(res);\n"
				+ "    max_index = -2;\n"
				+ "  }\n"
				+ "\n"
				+ "  Serial.printf(\"Zeiten: DSP %d ms, Inferenz %d ms, Anomalie %d ms\\n\",\n"
				+ "  result.timing.dsp, result.timing.classification, result.timing.anomaly);\n"
				+ "\n"
				+ "  Serial.println(F(\"Vorhersagen:\"));\n"
				...
				+ "  Serial.print(F(\"Anomalie-Vorhersage:\"));\n"
