...
public class ExtOut_WS2812Ring  extends TranslatorBlock {

	public ExtOut_WS2812Ring (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	//@Override
		...
		String Func="//--------- Neopixel Messanzeige (Gauge)\n" + 
   	    ...
   	    translator.addSetupCommand(setup);
			...
			String value,GPIO,size,delta,limit1,limit2,type;
...
//	   	    translator.addDefinitionCommand("Adafruit_NeoPixel WSpixels = Adafruit_NeoPixel("+size+","+GPIO+","+type+");");
	        ...
	        String ret = "  WSGauge("+value+","+limit1+","+limit2+","+delta+","+size+",1);\n";		
