...
public class Audio_Mic_Claps  extends TranslatorBlock {

	public Audio_Mic_Claps (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		String ret = "countClaps("+max+","+th+","+min+")";
