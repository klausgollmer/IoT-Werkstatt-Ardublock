...
public class AI_InfluxDB_create  extends TranslatorBlock {

	public AI_InfluxDB_create (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
