...
public class ExtDisp_LCDGroveRGB  extends TranslatorBlock {

	public ExtDisp_LCDGroveRGB (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
