...
public class AI_EDGE_RegModelCalibrate  extends TranslatorBlock {

	public AI_EDGE_RegModelCalibrate (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
...
*/			
	...
	String	EI_Def ="// ---- EDGE AI regression model data \n" + 
	    ...
	    modeltyp = translatorBlock.toCode();
			    
	    String Code = "AI_RegModelCalibrate("+modeltyp+"); // Select a regression model \n";
