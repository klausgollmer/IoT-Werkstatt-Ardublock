...
public class ExtSen_NFCWrite extends TranslatorBlock
{

  public ExtSen_NFCWrite (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
