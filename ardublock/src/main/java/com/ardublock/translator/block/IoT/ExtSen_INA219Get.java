...
public class ExtSen_INA219Get extends TranslatorBlock
{

  public ExtSen_INA219Get (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
  ...
  public String toCode() throws SocketNullException, SubroutineNotDeclaredException
  {
    ...
    translator.addSetupCommand("if (!ina219.begin()) IOTW_PRINTLN(\"no INA219\");\n");
