...
public class HTTP_BoschSpexSend  extends TranslatorBlock {

	public HTTP_BoschSpexSend (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
