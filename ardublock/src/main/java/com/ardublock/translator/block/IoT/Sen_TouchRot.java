...
public class Sen_TouchRot extends TranslatorBlock
{

  public Sen_TouchRot (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
