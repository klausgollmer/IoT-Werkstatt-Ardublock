...
public class SigProc_EMAsmooth extends TranslatorBlock
{

  public SigProc_EMAsmooth (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
