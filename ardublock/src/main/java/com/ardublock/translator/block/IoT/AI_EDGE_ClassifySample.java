...
public class AI_EDGE_ClassifySample  extends TranslatorBlock {

	public AI_EDGE_ClassifySample (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
