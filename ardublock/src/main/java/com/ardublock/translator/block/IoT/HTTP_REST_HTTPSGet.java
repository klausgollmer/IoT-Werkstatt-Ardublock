...
public class HTTP_REST_HTTPSGet  extends TranslatorBlock {
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		String httpGET ="// ----------------------------------------------------------------------------\n"
				...
				+ "    if (strlen(fingerprint) > 60) {  // SHA-256 nicht unterstützt\n"
				+ "      errorStringDebug += \"No SHA-256 fingerprint for ESP8266. \\n\";\n"
				+ "    } else {\n"
				...
				+ "    errorStringDebug += \"No SHA-1 fingerprint provided - using insecure connection!\\n\";\n"
				+ "  }\n"
				+ "#elif defined(ESP32)\n"
				+ "  if (strlen(fingerprint) > 1) {\n"
				+ "     errorStringDebug += \"ESP32 does not support SHA-1 and 256 certificate validation.\\n\";\n"
				+ "  } else {\n"
				+ "    client.setInsecure();  // ESP32 unterstützt KEIN SHA-1 Fingerprint-Check\n"
				+ "    errorStringDebug += \"No SHA fingerprint provided - using insecure connection!\\n\";\n"
				+ "  }\n"
				+ "#endif\n"
